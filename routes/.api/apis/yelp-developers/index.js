...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'yelp-developers/1.0 (api/6.1.2)');
    }
    /**
     ...
     */
    SDK.prototype.v3_business_search = function (metadata) {
     ...
     */
    SDK.prototype.v3_business_phone_search = function (metadata) {
     ...
     */
    SDK.prototype.v3_business_match = function (metadata) {
     ...
     */
    SDK.prototype.v3_business_info = function (metadata) {
     ...
     */
    SDK.prototype.v3_transaction_search = function (metadata) {
     ...
     */
    SDK.prototype.v3_get_businesses_engagement = function (metadata) {
     ...
     */
    SDK.prototype.v3_business_service_offerings = function (metadata) {
     ...
     */
    SDK.prototype.v3_business_rapc_enabledness = function (body, metadata) {
     ...
     */
    SDK.prototype.v3_businesses_insights = function (metadata) {
     ...
     */
    SDK.prototype.v3_get_business_food_and_drinks_insights = function (metadata) {
     ...
     */
    SDK.prototype.v3_post_natural_language_search = function (body) {
     ...
     */
    SDK.prototype.v1_ai_chat = function (body) {
